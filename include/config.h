...
// === TRIO HP CONFIGURATION ===
#define TRIO_HP_ENABLED 1
#define TRIO_HP_CAN_SPEED CAN_125KBPS
#define TRIO_HP_MAX_MODULES 48
#define TRIO_HP_HEARTBEAT_TIMEOUT_MS 10000
#define TRIO_HP_COMMAND_TIMEOUT_MS 5000
#define TRIO_HP_MODULE_DETECTION_ENABLED 1
#define TRIO_HP_AUTO_INITIALIZATION 1
#define TRIO_HP_HEALTH_CHECK_INTERVAL_MS 1000
#define TRIO_HP_DISCOVERY_ENABLED 1

// TRIO HP CAN ID ranges and constants
#define TRIO_HP_HEARTBEAT_BASE 0x0757F700
#define TRIO_HP_HEARTBEAT_MASK 0x0757F7FF
#define TRIO_HP_COMMAND_BASE 0x02A40000
#define TRIO_HP_RESPONSE_BASE 0x02A30000

// TRIO HP Modbus register ranges
#define TRIO_HP_MODBUS_START_REGISTER 5000
#define TRIO_HP_MODBUS_END_REGISTER 5199
#define TRIO_HP_REGISTERS_PER_MODULE 4
#define TRIO_HP_MAX_MODBUS_REGISTERS 200

// TRIO HP command definitions for quick access
#define TRIO_HP_CMD_MODULE_ON_OFF 0x1110
#define TRIO_HP_CMD_LED_BLINK 0x1120
#define TRIO_HP_CMD_SLEEP_MODE 0x1121
#define TRIO_HP_CMD_WORK_MODE 0x2110
#define TRIO_HP_CMD_ANTI_ISLANDING 0x2114
#define TRIO_HP_CMD_NATIONAL_SETTINGS 0x31C1

// TRIO HP MONITORING CONFIGURATION
#define TRIO_HP_MONITOR_ENABLED 1
#define TRIO_HP_BROADCAST_INTERVAL_DEFAULT 5000     // 5 seconds
#define TRIO_HP_MULTICAST_FAST_DEFAULT 500          // 500ms  
#define TRIO_HP_MULTICAST_SLOW_DEFAULT 1000         // 1000ms
#define TRIO_HP_DATA_HISTORY_SIZE_DEFAULT 10        // 10 data points
#define TRIO_HP_DATA_QUALITY_THRESHOLD 70           // 70% minimum quality
#define TRIO_HP_DATA_FRESHNESS_TIMEOUT 30000        // 30 seconds
#define TRIO_HP_POLL_TIMEOUT_DEFAULT 2000           // 2 second poll timeout
#define TRIO_HP_MAX_CONCURRENT_POLLS_DEFAULT 3      // 3 simultaneous polls

// TRIO HP CONFIG EEPROM LAYOUT  
#define TRIO_HP_CONFIG_EEPROM_START_ADDR 300        // Start after main config
#define TRIO_HP_CONFIG_EEPROM_TOTAL_SIZE 200        // 200 bytes allocated
#define TRIO_HP_CONFIG_BACKUP_ENABLED 1             // Enable backup config
